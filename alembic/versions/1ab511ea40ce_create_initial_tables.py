...
Revision ID: 1ab511ea40ce
Revises: 8ba739323849
Create Date: 2026-01-26 07:42:27.925835
...
revision: str = '1ab511ea40ce'
down_revision: Union[str, Sequence[str], None] = '8ba739323849'
...
def upgrade() -> None:
    ...
    sa.Column('usuarios', sa.Integer(), nullable=True),
    sa.Column('preco', sa.Float(), nullable=True),
    sa.ForeignKeyConstraint(['usuarios'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
